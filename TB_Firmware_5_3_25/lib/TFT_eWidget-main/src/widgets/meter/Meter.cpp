...
void MeterWidget::analogSpeedMeter(uint16_t x, uint16_t y, float fullScale, const char *units, const char *s0, const char *s1, const char *s2, const char *s3, const char *s4)
{
  analogSpeedMeter(x, y, 0.0, fullScale, units, s0, s1, s2, s3, s4);
}

void MeterWidget::analogSpeedMeter(uint16_t x, uint16_t y, float startScale, float endScale, const char *units, const char *s0, const char *s1, const char *s2, const char *s3, const char *s4)
{
  // Save offsets for needle plotting
  mx = x;
  my = y;
